...
C_DEPS += \
./rbwsFreeRTOS/src/rbwsFreeRTOS.d 

OBJS += \
./rbwsFreeRTOS/src/rbwsFreeRTOS.o 


# Each subdirectory must supply rules for building sources it contributes
rbwsFreeRTOS/src/%.o: ../rbwsFreeRTOS/src/%.c rbwsFreeRTOS/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-rbwsFreeRTOS-2f-src

clean-rbwsFreeRTOS-2f-src:
	-$(RM) ./rbwsFreeRTOS/src/rbwsFreeRTOS.d ./rbwsFreeRTOS/src/rbwsFreeRTOS.o

.PHONY: clean-rbwsFreeRTOS-2f-src
